...
<body>
	...
	<div class="wrapper">
		...
		<div id="content-wrapper">
			<div class="breadcrumb"><a href="index.php">Brevkasse > Teenageliv > Min veninder skifter...</a></div>
			<article>
				<h3>Spørgsmål</h3>
				<hr/>
				...
				<h1>Min veninder skifter mig ud gang på gang!</h1>
				<p>
				...
				<h3>Svar</h3>
				<hr/>
				<p class="light-text">Kevin den seje
					<time>20. okt 2013</time>
				</p>
				<p>
					Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
