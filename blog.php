...
<body>
    ...
    <div class="wrapper">
      ...
      <div id="content-wrapper">
        <div class="breadcrumb"><a href="index.php">Blogs > Unge blogs > Livet er lort!</a></div>
        <article>
          <p class="light-text">Emil den vilde - Dreng, 16 år 
            <time>20. okt 2013</time>
        </p>
        <h1>Livet er lort!</h1><img src="img/kitten.jpg" alt="kitten" width="100%"/>
        <p>
            ...
            Donec ultricies, tortor ac porta tempus, tortor quam aliquet velit, et porttitor nisl dolor
            fringilla magna.
        </p><img src="img/kitten-inline.jpg" alt="kitten2" width="200" class="left inline"/>
        <p>
            Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
            Aenean lobortis erat sit amet bibendum porta. Nunc congue orci vitae posuere vulputate.
            Vestibulum ullamcorper ipsum vel viverra facilisis. Integer molestie mauris sed enim dignissim,
        ...
        <p>
            ...
            Donec ultricies, tortor ac porta tempus, tortor quam aliquet velit, et porttitor nisl dolor
            fringilla magna.
        </p><img src="img/kitten-inline2.jpg" alt="kitten2" width="200" class="right inline"/>
        <p>
            Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos.
            Aenean lobortis erat sit amet bibendum porta. Nunc congue orci vitae posuere vulputate.
            Vestibulum ullamcorper ipsum vel viverra facilisis. Integer molestie mauris sed enim dignissim,
